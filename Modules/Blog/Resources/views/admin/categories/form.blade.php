...
<div class="card">
    <div class="card-header">
        <h4>{{ empty($category) ? __('blog::categories.add_card_title') : __('blog::categories.update_card_title') }}
        </h4>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer text-right">
        <button
            class="btn btn-primary">{{ empty($category) ? __('blog::categories.btn_create_label') : __('blog::categories.btn_update_label') }}</button>
    </div>
</div>
{!! Form::close() !!}
