                                            ...
                                            <td>
                                                @can('edit_blog-categories')
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ url('admin/blog/categories/' . $category->id . '/edit') }}"><i
                                                            class="far fa-edit"></i>
                                                        @lang('blog::categories.btn_edit_label') </a>
                                                @endcan
                                                @can('delete_blog-categories')
                                                    <a href="{{ url('admin/blog/categories/' . $category->id) }}"
                                                    ...
                                                    <form id="delete-role-{{ $category->id }}"
                                                        action="{{ url('admin/blog/categories/' . $category->id) }}"
                                                        method="post">
